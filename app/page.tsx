    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-12 animate-fade-in">
        ...
        <p className="mt-4 text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed">
          Practical guides on NHIS billing, offline hospital software, digital patient records, pharmacy stock control,
          patient safety, and clinic growth from the team behind MediSeen HMS.
        </p>
        <div className="mt-8 flex gap-4 justify-center flex-wrap">
          <a
            href="https://app.mediseenhms.com/register"
      ...
      <section className="mb-12 rounded-2xl bg-white border border-gray-100 p-5 shadow-sm">
        <h2 className="text-sm font-bold uppercase tracking-wide text-gray-500">SEO topic clusters</h2>
        <div className="mt-3 flex flex-wrap gap-2">
          {topicClusters.map(topic => (
            <span key={topic} className="text-sm font-medium bg-gray-100 text-gray-700 px-3 py-1.5 rounded-full">
              {topic}
            </span>
          ))}
        </div>
